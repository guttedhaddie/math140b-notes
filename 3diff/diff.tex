...
%\footnote{Alternatively $\displaystyle f'(a)=\lim_{h\to 0}\frac{f(a+h)-f(a)}{h}$ (see the homework).
%One benefit of this approach is that by replacing $a$ with $x$ one immediately obtains $f'(x)$ as a function of $x$.
%}
...
\boldinline{Notation} The contrasting styles are partly attributable,  to the primary founders of calculus, Issac Newton and Gottfried Leibniz. Each has its pros and cons and you should be comfortable with both.
